...
<body>
    <main>
                    ...
                    <div id="app" :class="['container']">
                            ...
                            <div class="message-body">
                                <div id="seo-preview">
                                    ...
                                    <div class="seo-url-preview">
                                        ...
                                        <span id="out_url">@{{ shop_domain }}blogs/@{{ blog_handle }}/@{{ url }}</span> <!--<span id="out_dash1"></span>-->
                                    </div>
                        ...
                        <form>
                            ...
                            <div class="control">
                                ...
                                <div id="shop_domain_el">@{{ shop_domain }}blogs/@{{ blog_handle }}/</div>
                                <div class="url-input">
                                    <span>@{{ shop_domain }}blogs/@{{ blog_handle }}/</span>
        ...
        <script src="{{ asset('js/script-post.js') }}"></script>
    </main>
